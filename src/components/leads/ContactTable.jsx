...
export default function ContactTable() {
  ...
  const getProjectStatusBadge = (status) => {
    ...
    const statusConfig = {
      ...
      awarded: { bg: "bg-green-100", text: "text-green-800", label: "Awarded" },
    };
                    ...
                    <td className="px-6 py-4">
                      <div className="max-w-xs">
                        ...
                        <div className="mt-2 flex flex-wrap gap-1">
                          {getProjectStatusBadge(lead.project_status)}
                          {lead.quotation_deadline && (
                            <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                              <Clock size={12} className="mr-1" />
                              {formatDate(lead.quotation_deadline)}
                            </span>
                          )}
                        </div>
                      </div>
            ...
            <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center space-x-4 mt-1">
                  {getProjectStatusBadge(selectedLead.project_status)}
                  {selectedLead.quotation_deadline && (
                    <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                      <Clock size={12} className="mr-1" />
                      Deadline: {formatDate(selectedLead.quotation_deadline)}
                    </span>
                  )}
                </div>
              </div>
                        ...
                        {selectedLead.quotation_deadline && (
                          <div>
                            ...
                            <div className="flex items-center">
                              ...
                              />
                              <p className="text-gray-900 font-medium">
                                {formatDate(selectedLead.quotation_deadline)}
                              </p>
                            </div>
                          </div>
                        )}
